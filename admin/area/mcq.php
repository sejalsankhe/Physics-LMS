            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Add Multiple Choice questions</h1>
                        
                    </div>
                    <form method="POST" action="handler/mcqadd.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <option value="num">Numericals</option>
                            <option value="txt">Theory</option>
